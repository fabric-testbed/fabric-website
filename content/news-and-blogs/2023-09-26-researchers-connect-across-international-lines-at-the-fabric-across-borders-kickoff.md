...
excerpt: "FABRIC Testbed leadership team members Anita Nikolich and Kuang-Ching Wang started the FAB Kickoff by welcoming everyone to the event. Nikolich expressed her gratitude to the many different players wh..."
author: "Yaxue Guo"
...
The introduction from Nikolich was followed by a partner roll call, beginning with talks from representatives at networks that will connect FABRIC to international sites: Jennifer Schopf, Director of International Networks at Indiana University [(NEA3R)](https://internationalnetworks.iu.edu/projects/NEA3R/index.html), and Julio Ibarra, Assistant Vice President of Technology Augmented Research at Florida International University [(AmLight)](https://www.amlight.net/). After Schopf and Ibarra shared information about the resources they could provide, presentations from partner universities and centers began.
...
Located in Chile, the [Rubin Observator](https://www.lsst.org/) will execute the Legacy Survey of Space and Time (LSST), a planned 10-year survey of the southern sky which will examine one-third of the sky each night and detect billions of stars and galaxies and millions of transients, variables, and moving objects — a data set of unprecedented volume and complexity.
...
To learn more about FAB and its partners, visit: [https://fabric-testbed.net/about/fab](https://fabric-testbed.net/about/fab).
