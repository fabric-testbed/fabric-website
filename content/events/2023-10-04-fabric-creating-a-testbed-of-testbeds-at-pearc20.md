...
category: "webinar"
fabric_hosted: false
excerpt: "FABRIC is a nation-wide programmable network that will enable creation of a new, secure, flexible Internet. Running over the ESnet optical backbone with links up to 1 Tbps, it interconnects supercompu..."
author: "Yaxue Guo"
...
**Event Website**: [https://pearc20.sched.com/event/cnXi](https://pearc20.sched.com/event/cnXi)
...
-   Leveraging FABRIC for Research (10 minutes each)
    -   [Ben Kirtman](https://ccs.miami.edu/team_member/benjamin-kirtman-phd/) (University of Miami) — _Scientific Computing_
    -   [Jason Mancuso](https://medium.com/@jvmancuso) (Cape Privacy) — _Distributed Machine Learning_
    -   [Christos Papadopoulos](https://www.cs.colostate.edu/~christos/) (Colorado State) — _IoT and Scientific Devices_
    -   [Ilkay Altintas](https://words.sdsc.edu/ilkay/) (UC San Diego) — _Data Analysis and Workflows_
