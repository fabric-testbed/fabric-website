...
function ContentCard({ item }: { item: ArticleMeta }) {
  return (
    <Link href={`/news-and-blogs/${item.slug}`}>
      <article className="group flex gap-6 p-6 rounded-xl border border-fabric-gray-200 hover:border-fabric-blue hover:bg-fabric-off-white transition-all duration-200 cursor-pointer">
