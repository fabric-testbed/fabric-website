...
export const stats: Stat[] = [
  ...
  { value: "—", label: "FABRIC User Publications",  detail: "The total number of papers and publications that reference the use of FABRIC.", href: "/research/publications" },
  ...
  { value: "—", label: "Total Projects",            detail: "A project is the term used to represent a logical grouping of users working on one or more related experiments over a period of time. Rights to resources are set at the project level.", href: "https://portal.fabric-testbed.net/experiments", external: true },
];
